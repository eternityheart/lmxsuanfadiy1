  ...
  return (
    <Layout>
      <div className="min-h-screen pb-20">
        {/* Header */}
        <div className="bg-gradient-to-b from-amber-50/80 to-transparent">
          <div className="container py-12">
            ...
            >
              <h1 className="text-3xl font-bold mb-4 text-gray-800">解题模板</h1>
        ...
        <div className="container py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-64 flex-shrink-0">
              <div className="sticky top-24 space-y-2 bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-amber-200/50">
                {templateList.map((template) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium">{template.data.name}</span>
                    </div>
                  </button>
                ))}
              </div>
                ...
                >
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-amber-200/50 shadow-lg">
                    <div className="flex items-center gap-3 mb-4">
                      <div 
                        className="w-10 h-10 rounded-lg flex items-center justify-center text-xl bg-amber-100"
                      >
                        {currentTemplate.category?.icon}
                      </div>
                      <div>
                        <h2 className="text-xl font-bold text-gray-800">{currentTemplate.data.name}</h2>
                        <p className="text-sm text-gray-600">{currentTemplate.data.description}</p>
                      </div>
                    </div>
